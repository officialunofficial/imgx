...
- *(transform)* Name the draw conflict in the 422 detail for thumbhash(7ccd391)
...
- Pin the Rust toolchain to 1.98.1(864821b)

### Other

- Merge branch 'main' into feat/thumbhash-placeholder(9345a09)

### Refactoring

- *(transform)* Pass one TransformSettings to transform()(9854ad4)
