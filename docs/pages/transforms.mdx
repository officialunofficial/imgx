...
Specify transforms as the last path segment in the URL. imgx treats a segment as a transform string when it contains `=`. Separate multiple parameters with commas.
