...
- **Size of the hash:** 17 to 25 bytes. The hash does not store the exact size of the output image. imgx hashes a thumbnail of at most 100 by 100 pixels. A near-square output, such as 4000 by 3999, therefore hashes as a square.
